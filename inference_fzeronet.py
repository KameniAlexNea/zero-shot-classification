...
class FZeroNetInference:
    ...
    def classify(
        ...
        # Tokenize
        inputs = self.tokenizer.tokenize_example(
        ...
        results = {
            ...
            "positive_scores": {
                label: float(score) for label, score in zip(positive_labels, positive_probs)
            },
            "negative_scores": {
                label: float(score) for label, score in zip(negative_labels, negative_probs)
            },
            "threshold": threshold
        }
    ...
    while True:
        ...
        try:
            result = inference_model.classify(
                text, positive_labels, negative_labels, threshold, return_all_scores=True
            )
